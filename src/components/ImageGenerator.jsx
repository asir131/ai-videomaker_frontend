...
Output ONLY the final prompt - no analysis or additional text.`;
  ...
  const handleGenerateWithSettings = async () => {
    ...
    if (!isAdvancedMode) {
      if (!generationSettings.imageCount || generationSettings.imageCount < 1) {
        alert(
          "Please enter a valid image count (1-" +
            Math.min(scenes.length, 15) +
            ").",
        );
        return;
      }
      ...
      if (!generationSettings.imageCount || generationSettings.imageCount < 1) {
        ...
        console.log(
          "Advanced Mode: Using all scenes, passing settings:",
          settingsWithImageCount,
        );
          ...
          >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      {isAdvancedMode
                        ...
                        : "Simple settings for quick generation"}
                    </p>
                  </div>
                </div>
                <button
                ...
                >
                  <span
                    className={`inline-block h-5 w-5 transform rounded-full bg-white shadow-md transition-transform duration-300 ${
                      isAdvancedMode ? "translate-x-8" : "translate-x-1"
                    }`}
                  />
                </button>
              </div>
            ...
            <div className="p-6 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50 flex flex-wrap justify-end gap-3 sticky bottom-0 z-20 backdrop-blur-md">
              ...
              <button
                ...
                className={`px-10 py-3 rounded-xl font-bold text-white transition-all transform hover:scale-[1.02] active:scale-[0.98] flex items-center gap-2 ${
                  !isFormValid()
        ...
        >
          ...
          >
            ...
            <div className="p-6 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Select a style for your generated images
              </p>
            </div>
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button
                      ...
                      className={`flex-1 min-w-[200px] px-6 py-3 font-bold rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 ${
                        isGeneratingImages
